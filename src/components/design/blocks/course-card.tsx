  ...
  return (
    ...
    >
      <div className="bg-muted aspect-video w-full overflow-hidden">
        {course.imageUrl ? (
          // An arbitrary URL string, deliberately not the Media collection's loader: this
          // folder stays independent of the Payload schema, so next/image has no loader to
          // optimise against. Swap to <Media /> when the component moves into public/.
